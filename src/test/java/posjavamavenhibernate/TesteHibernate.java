...
public class TesteHibernate {
	...
	public void testeHibernateUtil() {
		...
		pessoa.setNome("Enio");
		pessoa.setSenha("123");
		pessoa.setSobrenome("Polaco");
		pessoa.setEmail("enio.polaco@gmail.com");
	...
	public void testeGravaTelefone() {
		...
		telefoneUser.setNumero("98745147");
	...
	public void testeQueryList() {
		...
		List<UsuarioPessoa> list = daoGeneric.getEntityManager().createQuery(" from UsuarioPessoa where nome='Vanio'")
				.getResultList();
	...
	public void testQueryListParameter() {
		...
		List<UsuarioPessoa> list = daoGeneric.
				...
				.setParameter("nome", "Vanio")
				.setParameter("sobrenome", "Da Silva")
				.getResultList();
